...
static int printWordsInFile(char *filename, int maxLen, int printLength){
...
// define the maximum length of word we will look for, and by extension, the number of entries that must be in the array of word lists
